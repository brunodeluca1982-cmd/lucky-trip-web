      ...
      >
        ...
        <View style={s.descBlock}>
          ...
          <View style={s.descNoteWrap}>
            ...
            <Text style={s.descNoteText}>Seleção curada · {lugares.length} restaurantes</Text>
          </View>
        </View>
        ...
        >
          <Text style={s.cardsSectionLabel}>
            {selectedHotspot
              ? `${lugares.length} restaurante${lugares.length !== 1 ? "s" : ""} em ${RIO_HOTSPOTS.find(h => h.id === selectedHotspot)?.name ?? ""}`
          ...
          {lugares.length === 0 && selectedHotspot && (
            <View style={s.emptyState}>
              ...
              <Text style={s.emptyText}>
                Esta zona não tem restaurantes selecionados. Toque no mapa para explorar outra área.
              </Text>
            </View>
          )}
